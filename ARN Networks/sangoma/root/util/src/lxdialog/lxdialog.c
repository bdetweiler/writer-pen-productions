...
{
    {"--menu", 9, 0, 3, j_menu},
    {"--menuback", 9, 0, 3, j_menuback},
    {"--menutext", 9, 0, 3, j_menutext},
...
int
j_menuback (const char *t, int ac, const char * const * av)
{
    return dialog_menub (t, av[2], atoi (av[3]), atoi (av[4]),
			atoi (av[5]), av[6], (ac - 6) / 2, av + 7);
}
int
j_menutext (const char *t, int ac, const char * const * av)
{
    return dialog_menutext (t, av[2], atoi (av[3]), atoi (av[4]),
			atoi (av[5]), av[6], (ac - 6) / 2, av + 7);
}
...
{
    return dialog_textyesno (t, av[2], atoi (av[3]), atoi (av[4]));
}
